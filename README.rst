...
* The ``tests`` folder contains:
  ...
  - Example tests that you should replace with your own meaningful tests (file: ``test_CAT``)
...
* For convenience, the package version is stored in a single place: ``CAT/__version__.py``. For updating the version number, you only have to change this file.
...
.. code-block:: console
  ...
  git clone https://github.com/BvB93/CAT.git
  cd CAT
  pip install .
...
If you want to contribute to the development of Compound Attachment/Analysis Tool,
