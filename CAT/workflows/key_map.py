...
KEY_MAP: Mapping[str, Tuple[str, str]] = MappingProxyType({
    ...
    'JOB_SETTINGS_QD_OPT': ('settings', 'job_settings_qd_opt'),
    'JOB_SETTINGS_CRS': ('settings', 'job_settings_crs'),
    'JOB_SETTINGS_BDE': ('settings', 'job_settings_BDE'),
    'JOB_SETTINGS_ASA': ('settings', 'job_settings_ASA'),
    'JOB_SETTINGS_CDFT': ('settings', 'job_settings_cdft'),
